...
public class IndexController extends BaseController {
	...
	public JsonResult findAll(HttpServletRequest request){
		...
		try {
			...
			return new JsonResult(MaydayEnums.PRESERVE_ERROR.isFlag());
		}
		return new JsonResult(MaydayEnums.PRESERVE_SUCCESS.isFlag(),list);
	}
